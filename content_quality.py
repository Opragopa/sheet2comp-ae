...
FIRST_NAMES = {
    "александр", "александра", "алексей", "алена", "алина", "анастасия",
    "анатолий", "андрей", "анна", "антон", "арина", "артем", "артём",
    "артур", "борис", "вадим", "валентин", "валентина", "валерий",
    "валерия", "василий", "вера", "виктор", "виктория", "виталий",
    "владимир", "владислав", "вячеслав", "галина", "геннадий", "георгий",
    "глеб", "дарья", "денис", "диана", "дмитрий", "евгений", "евгения",
    "екатерина", "елена", "елизавета", "элла", "иван", "игорь", "илья",
    "инна", "ирина", "кирилл", "константин", "ксения", "лев", "леонид",
    "любовь", "людмила", "максим", "маргарита", "марина", "мария",
    "михаил", "надежда", "наталья", "никита", "николай", "олег", "ольга",
    "павел", "петр", "полина", "роман", "светлана", "семен", "сергей",
    "софия", "станислав", "степан", "татьяна", "тимофей", "федор",
    "фёдор", "юлия", "юрий", "яна", "ярослав",
}

COMMON_PATRONYMICS = {
    "александрович", "александровна", "алексеевич", "алексеевна",
    "альбертович", "альбертовна", "андреевич", "андреевна",
    "антонович", "антоновна", "артемович", "артемовна",
    "артурович", "артуровна", "борисович", "борисовна",
    "вадимович", "вадимовна", "валентинович", "валентиновна",
    "валериевич", "валериевна", "валерьевич", "валерьевна",
    "васильевич", "васильевна", "викторович", "викторовна",
    "витальевич", "витальевна", "владимирович", "владимировна",
    "владиславович", "владиславовна", "вячеславович", "вячеславовна",
    "георгиевич", "георгиевна", "глебович", "глебовна",
    "денисович", "денисовна", "дмитриевич", "дмитриевна",
    "евгениевич", "евгениевна", "евгеньевич", "евгеньевна",
    "иванович", "ивановна", "игоревич", "игоревна",
    "ильич", "ильинична", "кириллович", "кирилловна",
    "константинович", "константиновна", "левович", "львович", "львовна",
    "леонидович", "леонидовна", "максимович", "максимовна",
    "михайлович", "михайловна", "никитич", "никитична",
    "николаевич", "николаевна", "олегович", "олеговна",
    "павлович", "павловна", "петрович", "петровна",
    "романович", "романовна", "семенович", "семеновна",
    "сергеевич", "сергеевна", "станиславович", "станиславовна",
    "степанович", "степановна", "тимофеевич", "тимофеевна",
    "федорович", "федоровна", "юрьевич", "юрьевна",
...
def looks_like_patronymic(token):
    return str(token or "").lower().replace("ё", "е") in COMMON_PATRONYMICS
...
def canonical_last_first(value):
    ...
    if len(parts) >= 3:
        if looks_like_patronymic(parts[-1]):
            first_key = parts[0].lower().replace("ё", "е")
            second_key = parts[1].lower().replace("ё", "е")
